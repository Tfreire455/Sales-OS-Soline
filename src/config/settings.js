...
export const config = {
  ...
  GROUP_ID: process.env.GROUP_ID || '',                      // Grupo VIP (campanhas)
  GROUP_CADASTRO_ID: process.env.GROUP_CADASTRO_ID || '',    // Grupo de cadastro (fotos → planilha)
  ...
  PRODUCTS_TAB: process.env.PRODUCTS_TAB || 'Página1',
  DRIVE_FOLDER_ID: process.env.DRIVE_FOLDER_ID || '',
  COLUNA_STATUS: process.env.COLUNA_STATUS || 'Status Bot',
  CRM_SHEET_TABS: {
    clientes: process.env.CRM_TAB_CLIENTES || 'Clientes',
    pedidos: process.env.CRM_TAB_PEDIDOS || 'Pedidos',
    itens: process.env.CRM_TAB_ITENS || 'ItensPedido',
    pagamentos: process.env.CRM_TAB_PAGAMENTOS || 'Pagamentos',
    preferencias: process.env.CRM_TAB_PREFERENCIAS || 'PreferenciasIA',
    dashboard: process.env.CRM_TAB_DASHBOARD || 'Dashboard',
  },
